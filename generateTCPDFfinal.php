...
$custom = '<span style = "color: red"; align = "center">'.$bar[custombreakname]." ".$bar[startdate]." ".$bar[enddate];
$pdf->writeHTML($custom, true,false,true,false,'c');
