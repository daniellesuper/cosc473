		  ...
		  <ul>
				<li>
					...
					<div id="buttons">
						...
						<a href="weeklyschedule1.php?courseID=<?php echo $courseID ?>"><button type="button" class="btn btn-primary btn-lg">weekly1</a></button>
						<a href="<?php echo $courseID ?>"><button type="button" class="deleteButton">X</a></button>
					</div>
				</li>
		  </ul>
