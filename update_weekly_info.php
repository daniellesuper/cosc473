...
<form action="update_weekly_infohtml.php" form="get" style="padding-left: 25px;">

<div class="breakheader">
Break:  &nbsp; <select name="holiday" value="<?php echo $bar[holiday]; ?>">
         ...
         <div id="symbols">
           <?php
               foreach($row as $symbol){ 
                   if ($symbol == "Star"){
                     echo '<img src="images/star.jpeg"  width="15px" height="15px"/>'."<br>"."<br>";
                   } 
                   if ($symbol == "X"){
                     echo '<img src="images/x.jpeg"  width="15px" height="15"/>'."<br>"."<br>";
                   }
                   if ($symbol == "CheckMark"){
                     echo '<img src="images/checkmark.jpeg"  width="15" height="15"/>'."<br>"."<br>";
                   }
                   if ($symbol == "Exclamationpoint"){
                     echo '<img src="images/exclamation1.png"  width="15" height="15"/>'."<br>"."<br>";
                   }
                   if ($symbol == "Circle"){
                     echo '<img src="images/circle.png"  width="15" height="15"/>'."<br>"."<br>";
                   }
                   if ($symbol == "Kite"){
                     echo '<img src="images/Kite.png"  width="15" height="15"/>'."<br>"."<br>";
                   }
                   if ($symbol == "Square"){
                     echo '<img src="images/Square.jpeg"  width="15" height="15"/>'."<br>"."<br>";
                   }
                   if ($symbol == "Rectangle"){
                     echo '<img src="images/Rectangle.png"  width="30" height="15"/>'."<br>"."<br>";
                   }
                   if ($symbol == "Trefoil"){
                     echo '<img src="images/Trefoil.png"  width="15" height="15"/>'."<br>"."<br>";
                   }
                   if ($symbol == "Heart"){
                     echo '<img src="images/Heart.png"  width="15" height="15"/>'."<br>";
                   } 
               } 
              ?>  
           </div><!-- symbols id div -->
