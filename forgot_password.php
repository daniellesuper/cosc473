	...
	<body>
	  ...
	  <div class"col-md-6 col-offset-3" align="center">
		...
		<form method="post" action="send_pass.php">
		 ...
		 <?php 
		 error_reporting(0);
		 echo"If you have forgotten your password, don't worry. Please enter your account's email address below and click 'Send Email' button. You will receive an email with your password.";
		  if ($_GET['err']==1)
			{
