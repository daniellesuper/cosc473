...
<script>
function changeImage(selectID) {

alert(symbol1);
  //var x = document.getElementById("msymbol1").value;
...
?>
	Symbol1:  <select id="msymbol1" name="msymbol1" onchange="changeImage(symbol1)">
			<?php	display_symbols(); ?>
				<!-- Code for other option when clicked text box appears -->
